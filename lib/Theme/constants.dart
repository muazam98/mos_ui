...
class SalonTheme {
  ...
  static const String fontName = 'Karla';
  ...
  static ThemeData buildLightTheme() {
    final Color primaryColor = HexColor('#f8b1b8');
    final Color secondaryColor = HexColor('#f8b1b8');
  ...
  static const TextStyle headlineProfile = TextStyle(
    fontFamily: fontName,
    fontWeight: FontWeight.bold,
    fontSize: 16,
    letterSpacing: 0.27,
  ...
  static const formValue =
      TextStyle(fontSize: 16, letterSpacing: 1.5, fontWeight: FontWeight.w300);
}
